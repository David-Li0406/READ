...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def run(self):
        if self._model_type == "bert":
            try:
                from src.transformers.convert_bert_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from src.transformers.convert_transfo_xl_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from src.transformers.convert_gpt2_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from src.transformers.convert_xlnet_original_tf_checkpoint_to_pytorch import (
